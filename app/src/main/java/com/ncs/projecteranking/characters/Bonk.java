...
import com.ncs.projecteranking.GameEngine;
import com.ncs.projecteranking.Input;
import com.ncs.projecteranking.Scene;
...
public class Bonk extends Character {
    ...
    private static final int[][] ANIMATIONS = new int[][] {
            ...
            { 47, 48, 49, 50, 51, 50, 49, 48 },     // 9: dead but like actually dead
    };
    ...
    public void reset(int x, int y) {
        this.x = x;
        this.y = y;
        this.vx = 3;                // AQUESTA ES LA VELOCITAT HORITZONTAL DEL BONK
    }

    public void speedBoost(int vx) {
        this.vx = vx;

    }

    public boolean ArrowShow = false;
    ...
    public void alive() { changeState(1); }
